...
def thepossy():
    global stage
    x = sum(stage[i][5][1] for i in range(5))
    with open('Board_Data/AllPoss' + str(x - 1) + '.txt') as f:
        poss = f.readlines()
        for i in range(5):
            poss_temp = []
            for line in poss:
...
#     global points
#     global stage
#     points = [[[], [], [], [], [], [stage[0][5][0] + stage[0][5][1] - 5]],
#               [[], [], [], [], [], [stage[1][5][0] + stage[1][5][1] - 5]],
#               [[], [], [], [], [], [stage[2][5][0] + stage[2][5][1] - 5]],
#               [[], [], [], [], [], [stage[3][5][0] + stage[3][5][1] - 5]],
#               [[], [], [], [], [], [stage[4][5][0] + stage[4][5][1] - 5]],
#               [[stage[5][0][0] + stage[5][0][1] - 5],
#                [stage[5][1][0] + stage[5][1][1] - 5],
#                [stage[5][2][0] + stage[5][2][1] - 5],
#                [stage[5][3][0] + stage[5][3][1] - 5],
#                [stage[5][4][0] + stage[5][4][1] - 5],
#                []]]
...
#     is_none_y = [0, 0, 0, 0, 0]
#     for x, y in range(5):
#         if stage[y][x] == 1 or stage[y][x] == 2 or stage[y][x] == 3:
#             temp_points[y][5] += (1 - stage[y][x])
#             temp_points[5][x] += (1 - stage[y][x])
#             temp_points[y][x] = stage[y][x]
#     for i in range(5):
#         if temp_points[i][5] != 0:
#             non_zero_y += 1
#         if temp_points[5][i] != 0:
#             non_zero_x += 1
#     for x, y in range(5):
#         if stage[y][x] is None:
#             is_none_y[y] += 1
#             is_none_x[x] += 1
#     for x, y in range(5):
#         if stage[y][x] is None:
...
# if pyautogui.pixelMatchesColor(x=x_val, y=y_val, expectedRGBColor=(231, 115, 82):
#      game over
